...
// WithAlg sets the Alg field in the declarative configuration to the given value
// and returns the receiver, so that objects can be built by chaining "With" function invocations.
// If called multiple times, the Alg field is set to the value of the last call.
func (b *ChecksumApplyConfiguration) WithAlg(value string) *ChecksumApplyConfiguration {
	b.Alg = &value
	return b
}
