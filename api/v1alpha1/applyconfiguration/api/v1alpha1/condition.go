...
type ConditionApplyConfiguration struct {
	// Type of condition.
	Type *apiv1alpha1.ConditionType `json:"type,omitempty"`
...
func (b *ConditionApplyConfiguration) WithType(value apiv1alpha1.ConditionType) *ConditionApplyConfiguration {
	b.Type = &value
	return b
}
